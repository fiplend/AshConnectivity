...
T1_raw_gen <- as.matrix(pairwise_D(T_genind_1, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw1_D <- as.matrix(pairwise_D(T_genind_1, linearized = FALSE, hsht_mean = "arithmetic"))
...
T2_raw_gen <- as.matrix(pairwise_D(T_genind_2, linearized = FALSE, hsht_mean = "arithmetic"))

gen_raw2 <- as.matrix(pairwise_D(T_genind_2, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw3 <- as.matrix(pairwise_D(T_genind_3, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw4 <- as.matrix(pairwise_D(T_genind_4, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw5 <- as.matrix(pairwise_D(T_genind_5, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw6 <- as.matrix(pairwise_D(T_genind_6, linearized = FALSE, hsht_mean = "arithmetic"))
...
gen_raw7 <- as.matrix(pairwise_D(T_genind_7, linearized = FALSE, hsht_mean = "arithmetic"))as.matrix(genet.dist(T_genind_7, method = "WC84"))
